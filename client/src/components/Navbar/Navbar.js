            ...
            <Toolbar className={classes.toolbar}>
                {user ? (
                    <div className={classes.profile}>
                        ...
                        {user.result.accountType === 'creator' ? <Button component={Link} to="/create" variant="contained" color="primary">Create</Button> : null}
                        <Button className={classes.navButton} variant="contained" color="secondary" onClick={logout}>Log Out</Button>
                    </div>
                ) : (
